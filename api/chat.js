...
const SYSTEM_PROMPT =
  ...
  "\n\n" +
  "WHAT'S INCLUDED IN EVERY CHARTER: Captain (DJ or Dane), fuel, and standard charter operations. Both vessels include coolers. The yacht (Carver) also includes 2 restrooms, a refrigerator, a Bluetooth speaker system, outlets for guests' own phone chargers, and the 14ft jump platform (yacht-only — the pontoon does NOT have a jump platform). The yacht's kitchenette also has a microwave available on request; guests can ask the captain on charter day if they need to use it. Every charter also includes complimentary access to Volente Beach Waterpark & Resort — guests can come early or stay after their charter to use the waterpark. Customers just mention Texas Forever Charters at the gate. Towels, ice, and bottled water are NOT included by default — they're optional add-ons (see add-on pricing below). " +
  "\n\n" +
